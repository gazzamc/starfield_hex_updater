...
* For Starfield `v1.15.216` / `v1.15.222`  (and maybe beyond), you'll need a patched address library as a windows version was not released via nexus mods, this can be found on my discord.
